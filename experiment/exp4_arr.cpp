...
class Insertarray:public initarray
{
    ...
    for(int i=0;i<n;i++)
    {
        cout<<"The element "<<arr[i]<<" is in position "<<i+1<<endl;
    }
    cout<<"Enter how many element do you want to insert:";
    cin>>insnum;
    for(int i=0;i<insnum;i++){
        cout<<"Enter the index of the element to  be insert:";
        cin>>insertpos;
...
class Removearray:public Insertarray
{
    ...
    cout<<"Element the index of the element to be delete: ";
    cin>>rempos;
    ...
    int reverse()
{
    ...
    for (int i = 0; i < n; i++) {
        cout << "The element " << arr2[i] << " with position " << i + 1 << endl;
    }
    cout<<endl;
    return 0;
}
...
class Searcharray:public Reversearray
{
    ...
    int search()
    {
        ...
        for(int i=0;i<n;i++)
        {
            if(arr[i]==searchval)
            {
                cout<<"Element "<<arr[i]<<" is at the "<<i+1<<"th position";
                o=1;
                break;
            }
